...
def assign_relevance_score(result: typesCore.Result):
    ...
    if result.did_match_source_language:
        result.relevance_score = (
            1000
            - 20 *
            _default_if_none(result.query_wordform_edit_distance, default=0)
        ...
        result.relevance_score = (
            ...
            + -0.0009984537 * \
            _default_if_none(result.morpheme_ranking, default=1)
